...
<div class={`absolute w-screen h-screen z-20 top-0 grid-cols-3 grid place-content-center transition duration-700 ${opaque ? "opacity-100 select-text" : "opacity-0 select-none"}`} aria-hidden={opaque}>
